...
const GAME_BASE = '/games/huruf-builder/';
    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          ...
          icons: [
            {
              src: '/games/huruf-builder/assets/icons/icon-512.png',
              sizes: '512x512',
              type: 'image/png',
            },
            {
              src: '/games/huruf-builder/assets/icons/icon-192.png',
              sizes: '192x192',
              type: 'image/png',
            },
            {
        ...
        workbox: {
          // Same reasoning as asma-match: the Piper TTS fallback (~14MB) is
          // fetched lazily on first "Hear it" tap, never eagerly precached.
