...
const GAME_BASE = '/games/precalc-functions/';
    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          ...
          start_url: GAME_BASE,
          icons: [
            { src: '/games/precalc-functions/assets/icons/icon-512.png', sizes: '512x512', type: 'image/png' },
            { src: '/games/precalc-functions/assets/icons/icon-192.png', sizes: '192x192', type: 'image/png' },
            { src: '/games/precalc-functions/assets/icons/icon-512.png', sizes: '512x512', type: 'image/png', purpose: 'maskable' },
          ],
        },
        workbox: {
