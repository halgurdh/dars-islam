...
const STRINGS: Record<LangMode, Strings> = {
  ...
  ar: {
    subtitle: 'Prophets Builder',
    tagline: 'تعلّم أسماء الأنبياء\nمن خلال تهجئة كل اسم.',
    itemsLearned: (n, total) => `${n} / ${total} من الأنبياء تم تعلّمهم`,
    easy: 'سهل · 8 أنبياء',
    medium: 'متوسط · 15 نبيًا',
    hard: 'صعب · 25 نبيًا',
    soundOn: '🔈 الصوت مفعّل',
    ...
    wellDone: 'أحسنت! 🌿',
    roundSummary: (items, mistakes, time, learned, total) =>
      `${items} أنبياء تم تهجئتهم بـ ${mistakes} أخطاء\nالوقت: ${time}\n${learned} / ${total} من الأنبياء تم تعلّمهم إجمالًا`,
    ...
    instruction: 'اضغط على الأنبياء بالترتيب التقليدي',
