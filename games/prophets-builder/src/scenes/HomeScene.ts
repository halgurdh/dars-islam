...
function generateListenQuestion(): QuizQuestion {
  const [correct, ...distractors] = shuffle(PROPHETS).slice(0, 4);
...
export const HomeScene = createModeMenuScene({
  ...
  modes: [
    ...
    listenMode({
      ...
      difficulties: [
        { label: () => t().easy, totalQuestions: 8, generateQuestion: generateListenQuestion },
        { label: () => t().medium, totalQuestions: 12, generateQuestion: generateListenQuestion },
        { label: () => t().hard, totalQuestions: 16, generateQuestion: generateListenQuestion },
      ],
    }),
    flashcardMode({
    ...
    quizMode({
      ...
      difficulties: [
        { label: () => t().easy, totalQuestions: 8, generateQuestion: generateTrueFalseQuestion },
        { label: () => t().medium, totalQuestions: 12, generateQuestion: generateTrueFalseQuestion },
        { label: () => t().hard, totalQuestions: 16, generateQuestion: generateTrueFalseQuestion },
      ],
    }),
    quizMode({
      id: 'fillblank',
      ...
      difficulties: [
        { label: () => t().easy, totalQuestions: 8, generateQuestion: generateFillBlankQuestion },
        { label: () => t().medium, totalQuestions: 12, generateQuestion: generateFillBlankQuestion },
        { label: () => t().hard, totalQuestions: 16, generateQuestion: generateFillBlankQuestion },
      ],
    }),
  ],
});
