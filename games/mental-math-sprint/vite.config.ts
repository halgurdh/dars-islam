...
const GAME_BASE = '/games/mental-math-sprint/';
    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          ...
          start_url: GAME_BASE,
          icons: [
            { src: '/games/mental-math-sprint/assets/icons/icon-512.png', sizes: '512x512', type: 'image/png' },
            { src: '/games/mental-math-sprint/assets/icons/icon-192.png', sizes: '192x192', type: 'image/png' },
            { src: '/games/mental-math-sprint/assets/icons/icon-512.png', sizes: '512x512', type: 'image/png', purpose: 'maskable' },
          ],
        },
        workbox: {
