...
const GAME_ID = 'kind-hearts';
const MATCH_PAIRS = 8;
const SEQUENCE_COUNT = 6;

// No difficulty tiers here — each mode is a single pool that reshuffles
// itself every run, so every mode gets one "Start" button instead of three.
