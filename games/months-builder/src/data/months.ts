...
export const MONTHS: BuilderItem[] = [
  { id: 1, arabic: 'مُحَرَّم', transliteration: 'Muharram', meaningEn: '1st month of the Hijri year — one of the four sacred months', meaningAr: 'الشهر الأول من السنة الهجرية — أحد الأشهر الحرم الأربعة', meaningNl: '1e maand van het Hijri-jaar — een van de vier heilige maanden', meaningDe: '1. Monat des Hijri-Jahres — einer der vier heiligen Monate', meaningEs: '1.º mes del año hégira — uno de los cuatro meses sagrados', meaningFr: "1er mois de l'année hégirienne — l'un des quatre mois sacrés" },
