...
const GAME_BASE = `${process.env.VITE_BASE_PATH ?? '/'}games/phrase-explorer/`;
    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          ...
          short_name: 'PhraseExplorer',
          description: 'Learn everyday sentences and expressions across several languages.',
          theme_color: '#1f1508',
          background_color: '#1f1508',
          display: 'standalone',
