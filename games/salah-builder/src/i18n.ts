...
const STRINGS: Record<LangMode, Strings> = {
  ...
  ar: {
    subtitle: 'Salah Builder',
    tagline: 'تعلّم خطوات الصلاة اليومية\nمن خلال تهجئة كل خطوة.',
    itemsLearned: (n, total) => `${n} / ${total} من الخطوات تم تعلّمها`,
    easy: 'سهل',
    medium: 'متوسط',
    hard: 'صعب',
    soundOn: '🔈 الصوت مفعّل',
    ...
    wellDone: 'أحسنت! 🌿',
    roundSummary: (items, mistakes, time, learned, total) =>
      `${items} خطوات تم تهجئتها بـ ${mistakes} أخطاء\nالوقت: ${time}\n${learned} / ${total} من الخطوات تم تعلّمها إجمالًا`,
    ...
    instruction: 'اضغط على خطوات الصلاة بالترتيب',
