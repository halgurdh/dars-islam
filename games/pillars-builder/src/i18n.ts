...
const STRINGS: Record<LangMode, Strings> = {
  ...
  ar: {
    subtitle: 'Pillars Builder',
    tagline: 'تعلّم أركان الإسلام الخمسة\nبتهجئة كل ركن منها.',
    itemsLearned: (n, total) => `${n} / ${total} أركان تم تعلّمها`,
    easy: 'سهل',
    medium: 'متوسط',
    hard: 'صعب',
    ...
    wellDone: 'أحسنت! 🌿',
    roundSummary: (items, mistakes, time, learned, total) =>
      `تم تهجئة ${items} أركان بـ ${mistakes} أخطاء\nالوقت: ${time}\n${learned} / ${total} أركان تم تعلّمها إجمالًا`,
    ...
    instruction: 'اضغط على الأركان بترتيبها المعتاد',
