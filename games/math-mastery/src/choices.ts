...
/** Builds 4 unique string choices (e.g. fractions, trig values) from a correct answer plus distractor pool. */
export function buildStringChoices(correct: string, pool: string[]): { choices: string[]; correctIndex: number } {
