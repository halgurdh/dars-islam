...
import { ASMA_UL_HUSNA } from '../data/names';
...
export class MenuScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    this.add.text(width / 2, height * 0.12, 'أسماء الله الحسنى', {
    ...
    this.add.text(width / 2, height * 0.27, t().namesLearned(learned, ASMA_UL_HUSNA.length), {
      fontFamily: LATIN_FONT,
      fontSize: '15px',
      color: hex(COLORS.accent),
    }).setOrigin(0.5);
