...
// of overlapping into a garbled mess. Sfx.speak() always calls stopPiper()
// before starting anything new (on either engine), so this only ever holds
// at most one clip.
...
export async function synthesize(
  ...
  // vite.config.ts for why the library's default (cdnjs) path is broken.
