...
const STRINGS: Record<LangMode, Strings> = {
  ...
  ar: {
    subtitle: 'Letter Trace',
    tagline: 'تدرّب على الكتابة اليدوية بتتبع كل حرف\nبإصبعك أو بالماوس.',
    alphabetArabic: '🔤 العربية',
    alphabetEnglish: '🔤 الإنجليزية',
    alphabetNumbers: '🔢 الأرقام',
    itemsLearned: (n, total) => `${n} / ${total} حرف تم تتبعه`,
    start: 'ابدأ',
    soundOn: '🔈 الصوت مفعل',
    ...
    menu: '☰ القائمة',
    accuracy: (n) => `الدقة: ${n}%`,
    coverage: (n) => `التغطية: ${n}%`,
    hear: '🔊 استمع',
    reset: '↻ إعادة تعيين / حاول مجددًا',
    confirm: '✓ تأكيد',
    next: 'التالي →',
    wellDone: 'أحسنت! 🌿',
    itemComplete: 'تتبع رائع!',
    roundSummary: (items, total) => `تم تتبع ${items} حرفًا في هذه الجولة\n${total} تم تعلمها إجمالًا`,
    nextLevelHint: 'الحرف التالي يبدأ…',
    playAgain: '↻ تدرّب مجددًا',

    modeTrace: '✍️ تتبع',
    modeMatch: '🃏 مطابقة',
    modeSequence: '🔢 ترتيب',

    matchMoves: (n) => `الحركات: ${n}`,
    matchRoundSummary: (pairs, moves) => `تمت مطابقة ${pairs} من الأزواج في ${moves} حركة`,

    sequenceRound: (i, total) => `الجولة ${i} / ${total}`,
    sequenceMistakes: (n) => `الأخطاء: ${n}`,
    sequenceInstruction: 'اضغط عليها بالترتيب الصحيح',
    sequenceRoundSummary: (perfect, total) => `${perfect} / ${total} تم وضعها بشكل صحيح`,
  },
};
