...
export const JUZ_AMMA_SURAHS: SurahEntry[] = [
  ...
  { id: 5, arabic: 'الْمَسَد', transliteration: 'Al-Masad', meaningEn: 'The Palm Fibre', meaningAr: 'ليف النخل', meaningNl: 'De Palmvezel', meaningDe: 'Die Palmfaser', meaningEs: 'La Fibra de Palma', meaningFr: 'La Fibre de Palmier' },
