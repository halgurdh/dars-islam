...
const GAME_BASE = `${process.env.VITE_BASE_PATH ?? '/'}games/health-body/`;
  ...
  return {
    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          name: 'Health & The Body',
          short_name: 'HealthTheBody',
          description: 'Nutrition, hygiene and how the body works.',
          theme_color: '#1a0f0f',
