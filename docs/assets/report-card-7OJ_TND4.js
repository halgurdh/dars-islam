import{G as p}from"./certificates-DjcvdW16.js";import{t as c}from"./report-api-BlDYw9SI.js";function s(e){return e.replace(/[&<>"']/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[r])}let i=!1;function d(){if(i||document.getElementById("report-card-styles"))return;i=!0;const e=document.createElement("style");e.id="report-card-styles",e.textContent=`
