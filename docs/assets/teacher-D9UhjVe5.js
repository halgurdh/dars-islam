import"./theme-BRE4rC8K.js";import{s as f}from"./sync-CsgRh07u.js";import{S as i,a as w,G as y}from"./certificates-DyPrvBPs.js";import{P as $}from"./progress-bar-D1fgc0yC.js";import{s as g}from"./report-card-OKz5jD7D.js";const S={school:"🏫 School",mosque:"🕌 Mosque",homeschool:"🏡 Homeschool",other:"📚 Other"};function C(a){return a?Math.floor((Date.now()-new Date(a+"T00:00:00").getTime())/864e5):1/0}function E(a,e){const t=e.map(l=>l.map(d=>`"${String(d??"").replace(/"/g,'""')}"`).join(",")).join(`\r
